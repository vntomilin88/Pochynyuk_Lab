...
cond = {
        ...
        '22_10_5_mCD': ['2022.10.5 подгон', 0.13, 1.4, 225, 1550, 300],
        '22_10_13_mCD': ['2022.10.13 mCD EGTA-Iono 002(6)', 0.135, 1.32, 225, 1900, 400]
        }


# Rmin = 0.13 #новые значения которые пришлось подгонять из-за выгорания лампы, взял контрольный эксперимент и подогнал значения чтобы совпадало со старым
# Rmax = 1.4 #новые значения 2022.10.5
# Kd = 225
# Sf2 = 1550
# Sb2 = 300
